...
load("//npm/private:yarn_lock_repository.bzl", _yarn_lock_repository = "yarn_lock_repository")
load("//npm/private:yarn_tool_repository.bzl", _yarn_tool_repository = "yarn_tool_repository")
...
yarn_lock_repository = _yarn_lock_repository
yarn_tool_repository = _yarn_tool_repository
